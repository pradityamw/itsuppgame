...
const id = {
  ...
  completed: 'Selesai',
  locked: 'Terkunci',
  logoutConfirm: 'Apakah Anda yakin ingin keluar untuk mengganti akun?',
  resetLevel: 'Reset Level',
  resetLevelConfirm: 'Apakah Anda yakin ingin mengatur ulang semua koneksi dan posisi perangkat ke awal?',
  resetLevelSuccess: 'Level berhasil diatur ulang!',
};
